...
def find_lab_test(test_code):
    ...
    frappe.throw(_("Unable to find test with invoice: ") + test_code)
...
def find_sample_collection(test_code):
    ...
    frappe.throw(_("Unable to find sample collection with invoice: ") + test_code)
...
def find_sales_invoice(test_code):
    ...
    frappe.throw(_("Unable to find sales invoice with code: ") + test_code)